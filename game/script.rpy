...
label hiBranch:
   menu:
      ...
      "Well, well, what's a fine young fir do in a place like this?":
         t "..."
         show emotes content at emotePos with fade
         $ affinity += 1
         jump afterHi
...
menu:
   "So… What's your name?" if whatsYourName == False:
      ...
      show emotes okay at emotePos with fade
      $ affinity += 2
      $ whatsYourName = True
      jump chooseName
   ...
   "Do you come here often?" if comeHereOften == False:
      ...
      show emotes cute at emotePos with fade
      $ affinity += 1
      $ comeHereOften = True
      jump beforeName
   ...
   "Lick the tree" if hasLickedTheTree == False:
      ...
      show emotes pissed at emotePos with fade
...
label chooseName:
   menu:
      "Come on tell me?" if nameComeOn == False:
         ...
         show emotes bored at emotePos with fade
         $ nameComeOn = True
         $ affinity -= 1
         jump chooseName
      ...
      "Can I call you Victorius Darrell?":
         ...
         show emotes proud at emotePos with fade
         $ affinity += 2
...
label lickTheTree: 
   menu:
      "Sorry I was moving to fast.":
         ...
         show emotes shySmile at emotePos with fade
         $ affinity += 1
         jump beforeName
      ...
      "Why does it always have to end this way (Chop down the tree)?":
         ...
         show emotes shock at emotePos with fade
         ...
         show emotes unhappy at emotePos with fade
...
label afterName:
   ...
   menu:
      ...
      "Oh sorry, I guess that was a little insensitive of me.":
         ...
         show emotes relaxed at emotePos with fade
         $ affinity += 2
         jump afterBeaver
      ...
      "You ever had a run in with a beaver, I hear they have nasty teeth?":
         ...
         show emotes relaxedBlush at emotePos with fade
         $ affinity += 1
         jump afterBeaver
...
label afterMove:
   ...
   menu: 
      "Uh, I feel a little bit cold, could you lend me some “fir”?" if lendMeSomeFir == False:
         ...
         show emotes superHappy at emotePos with fade
