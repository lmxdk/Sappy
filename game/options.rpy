...
init -1 python hide:
    ...
    config.screen_width = 1440#2000#800
    config.screen_height = 1080#1500#600

    ## This controls the title of the window, when Ren'Py is
    ## running in a window.

    config.window_title = u"Sappy"
    ...
    theme.marker(
        ...
        widget = "#f6b7d2", #898989",

        ## The color of a focused widget face.
        widget_hover = "#ed4794", #464646",

        ## The color of the text in a widget.
        widget_text = "#ffffff", #CCCCCC",

        ## The color of the text in a selected widget. (For
        ## example, the current value of a preference.)
        widget_selected = "#482546", #F2F2F2",
        ...
        mm_root = "images/splash.png", #"#393939",

        ## The background of the game menu. This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = "images/forest.png", #393939",
    ...
    config.main_menu_music = "music/TreeDating.ogg" 
...
python early:
    config.save_directory = "Sappy-1460485639"
